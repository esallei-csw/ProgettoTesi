...
type TQueryUtilityHandler = class
  ...
  {Public declarations}
    ...
    function QueryToCalendar(AQuery:TADOQuery): TList<TCalendarModel>;
...
function TQueryUtilityHandler.QueryToCalendar(
...
begin
  ...
  try
    ...
    begin
      ...
      LDay.ID := AQuery.FieldByName(ID).AsInteger;
      LDay.IDCalendar := AQuery.FieldByName(CALENDAR_ID).AsInteger;
      LDay.IDCell := AQuery.FieldByName(IDCELPRO).AsInteger;
      LDay.Day := AQuery.FieldByName(CALENDAR_DAY).AsInteger;
      LDay.TotOre := AQuery.FieldByName(CALENDAR_TOTORE).AsFloat;
...
begin
  ...
  try
    ...
    begin
      ...
      LMachineStop.ID := AQuery.FieldByName(STOPS_ID).AsInteger;
      LMachineStop.IDCell := AQuery.FieldByName(STOPS_ID).AsInteger;
